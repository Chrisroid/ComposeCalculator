...
import androidx.compose.ui.unit.dp
import com.example.composecalculator.model.OperatorType
import com.example.composecalculator.model.ParseException
import com.example.composecalculator.model.parseExpression
                ...
                item {
                    CalcButton(
                        ...
                        onClick = {
                            ...
                            try {
                                answerState.value =
                                    inputState.value.parseExpression().value.toString()
